...
urlpatterns = [
    ...
    path(
        "create_post-CV",
        CreateViewNewPost.as_view(),
        name="createViewNewPost",
    ),
    path(
        "<int:pk>/edit", UpdateViewToEdit.as_view(), name="updateViewToEdit"
    ),
    path(
        "<int:pk>/delete",
        DeleteViewToDelete.as_view(),
        name="deleteViewToDelete",
    ),
