...
class PostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Post
        fields = ['id', 'author', 'title', 'image', 'content', 'snippet', 'status', 'category', 'relative_url', 'absolute_url', 'created_date', 'updated_date', 'published_date']
    ...
    def to_representation(self, instance):
        ...
        rep['category'] = CategorySerializer(instance.category).data # way3: showing detail of category instead of id only
        return rep
