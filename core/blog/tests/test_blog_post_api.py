...
class TestPostApi:
    ...
    def test_postMethod_unAuthorized_createPost_response_401_status_code(
        self, apiClient
    ):
        url = reverse("blog:api-v1:post-list")
        data = {
    ...
    def test_postMethod_Authorized_createPost_validData_response_201_status_code(
        self, common_user, apiClient
    ):
        url = reverse("blog:api-v1:post-list")
        user = common_user
    ...
    def test_postMethod_Authorized_createPost_invalidData_response_400_status_code(
        self, apiClient, common_user
    ):
        url = reverse("blog:api-v1:post-list")
        user = common_user
        apiClient.force_login(user)
